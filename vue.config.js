 ...
 * @LastEditors: zhoukai
 * @LastEditTime: 2024-07-29 18:01:26
 */
...
// git 提交哈希
const { gitHash, isEnvDevelopment, isEnvProduction, BUNDLE_ANALYZE } = require('./util');
...
module.exports = defineConfig({
    ...
    css: {
        ...
        extract: !isEnvDevelopment ? { ignoreOrder: true } : false
    },
    // 调整内部的 webpack 配置。
            ...
            optimization: {
                ...
                splitChunks: {
                    ...
                    cacheGroups: {
                        ...
                        'vendors/ui': {
                            name: 'vendors/ui',
                            test: /[\\/]node_modules[\\/](nprogress|element-ui)[\\/]/,
                            priority: 6
                        },
                        'vendors/core-js': {
