 ...
 * @LastEditors: zhoukai
 * @LastEditTime: 2024-07-29 17:33:41
 */
...
axios.interceptors.request.use(
    function (config) {
        // 显示loading
        loading.show(config.loadingTarget);
    ...
    function (error) {
        // 隐藏loading
        loading.hide(error.config.loadingTarget);
...
axios.interceptors.response.use(
    function (response) {
        // 隐藏loading
        loading.hide(response.config.loadingTarget);
    ...
    function (error) {
        // 隐藏loading
        loading.hide(error.config && error.config.loadingTarget);
